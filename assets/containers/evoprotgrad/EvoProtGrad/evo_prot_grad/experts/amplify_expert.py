...
class AmplifyExpert(ProteinLMExpert):
    ...
    def __init__(self,
        ...
        if model is None and tokenizer is None:
            ...
            raise ValueError("AmplifyExpert requires both `model` and `tokenizer` to be specified.")
    ...
    def tokenize(self, inputs: List[str]) -> BatchEncoding:
        ...
        return self.tokenizer(inputs, add_special_tokens=False, return_tensors="pt", return_attention_mask=False).to(self.device)
