...
workflow Chai1 {
    take:
        ...
        trunk
        esm2_config
        esm2_pytorch_model-00001-of-00002
        esm2_pytorch_model-00002-of-00002
        esm2_pytorch_model.bin.index
...
process Chai1Task {
    ...
    input:
        path fasta_path
        var num_diffn_timesteps
        var num_trunk_recycles
        ...
        path trunk
        path esm2_config
        path esm2_pytorch_model-00001-of-00002
        path esm2_pytorch_model-00002-of-00002
        path esm2_pytorch_model.bin.index
    ...
    ln -t esm/models--facebook--esm2_t36_3B_UR50D/snapshots/476b639933c8baad5ad09a60ac1a87f987b656fc \
        $esm2_config $esm2_pytorch_model-00001-of-00002 \
        $esm2_pytorch_model-00002-of-00002 \
        $esm2_pytorch_model.bin.index \
        $esm2_special_tokens_map \
        $esm2_tokenizer_config \
...
workflow {
    Chai1(
        ...
        Channel.fromPath(params.num_diffn_timesteps)
        Channel.fromPath(params.num_trunk_recycles)
        ...
        Channel.fromPath(params.esm2_pytorch_model-00001-of-00002)
        Channel.fromPath(params.esm2_pytorch_model-00002-of-00002)
        Channel.fromPath(params.esm2_pytorch_model.bin.index)
