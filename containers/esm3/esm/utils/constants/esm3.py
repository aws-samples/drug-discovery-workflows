...
INTERPRO_ENTRY = "esm/data/esm3_entry.list"
INTERPRO_HIERARCHY = "esm/data/ParentChildTreeFile.txt"
INTERPRO2GO = "esm/data/ParentChildTreeFile.txt"

LSH_TABLE_PATHS = {
    "8bit": "esm/data/hyperplanes_8bit_58641.npz",
}

TFIDF_VECTOR_SIZE = 58641
TFIDF_MODEL = "esm/data/tfidf_safety_filtered_58641.pkl"
INTERPRO_2ID = "esm/data/tag_dict_4.json"

RESID_CSV = "esm/data/uniref90_and_mgnify90_residue_annotations_gt_1k_proteins.csv"
INTERPRO2KEYWORDS = "esm/data/interpro2keywords.csv"
